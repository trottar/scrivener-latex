...
\begin{Mfigure}{Target Loop}
  ...
  \caption{ CAD view of the cryogenic and solid target ladders. There are three cyrogenic loops above the solid target ladder. [\cite{sta_jeerson_2019}]}
...
% Helps fix infinite loop issue
% From GPT
%The \clearpage command forces LaTeX to output all pending floats (figures and tables) and start a new page. Any floats that have not yet been placed will be placed on the current page before the page break. After a \clearpage command, LaTeX starts a new page, so subsequent content will appear on a new page.
%The \FloatBarrier command, provided by the placeins package, forces LaTeX to output all pending floats before continuing. Unlike \clearpage, it does not start a new page; instead, it ensures that all floats have been placed up to that point in the document.
%\FloatBarrier can be useful when you want to prevent floats from floating past a certain point in your document, such as a section or subsection heading. It acts as a barrier that prevents floats from moving past it.
...
\begin{figure}
  \centering
  \begin{minipage}[b]{0.48\linewidth}
    \includegraphics[width=\linewidth]{Q2p1W2p95_unsep_eps_1.pdf}
  \end{minipage}
  \hfill
  \begin{minipage}[b]{0.48\linewidth}
    \includegraphics[width=\linewidth]{Q2p1W2p95_unsep_eps_2.pdf}
  \end{minipage}
...
\begin{Mfigure}{Q2p1W2p95_unsep_t}
  \centering
  \includegraphics[width=0.65\linewidth]{Q2p1W2p95_unsep_t.pdf}
...
\begin{Mfigure}{Q3p0W3p14_unsep_t}
  \centering
  \includegraphics[width=0.65\linewidth]{Q3p0W3p14_unsep_t.pdf}
